...
import { Users, CreditCard, Wallet, BarChart3, ChevronUp, TrendingUp, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatCard 
          ...
          value={loadingPayments ? '...' : formatCurrency(stats.totalTransacted)} 
          icon={<BarChart3 className="h-5 w-5 text-indigo-500" />}
          linkTo="/payments"
        />
        <StatCard 
          title="Pagamentos Pagos" 
          value={loadingPayments ? '...' : stats.paidCount} 
        ...
        <StatCard 
          ...
          value={loadingPayments ? '...' : formatCurrency(stats.totalRetido)} 
