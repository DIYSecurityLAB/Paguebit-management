...
import { CreditCard, Users, Wallet, Bell, Sun, Moon, Menu, X, Home, Search, Store as StoreIcon, Tag } from 'lucide-react';
...
export default function Header() {
  ...
  const navItems = [
    ...
    { path: '/stores', label: 'Lojas', icon: StoreIcon, key: 'l' },
    { path: '/coupons', label: 'Cupons', icon: Tag, key: 'c' }, // <-- Adicionado
